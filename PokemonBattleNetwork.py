...
class Editor():
	...
	def tick(self):
		...
		if buttonInput[K_UP]:
			editor.scroll("up")
		elif buttonInput[K_DOWN]:
			editor.scroll("down")
		elif buttonInput[K_LEFT]:
			editor.scroll("left")
		elif buttonInput[K_RIGHT]:
			editor.scroll("right")
		#elif buttonInput[K_PAGEUP]:
		#	editor.scroll("bigUp")
		#elif buttonInput[K_PAGEDOWN]:
		#	editor.scroll("bigDown")
		elif buttonInput[K_SPACE]:
			editor.select()
